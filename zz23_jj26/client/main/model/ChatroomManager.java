package zz23_jj26.client.main.model;
...
import zz23_jj26.client.message.chat.JoinChatroomMessage;
import zz23_jj26.client.message.connect.ChatroomInviteMessage;
import zz23_jj26.client.message.connect.ConnectBack;
import zz23_jj26.client.message.connect.ConnectMessageVisitor;
import zz23_jj26.client.message.connect.GetChatroomsListMessage;
import zz23_jj26.client.message.connect.RequestChatroomMessage;
import zz23_jj26.client.mini.controller.MiniController;
...
//	private IUserRMIWrapper stub;
	 ...
	 * starts up the class CLIENT and installs the security manager.
	 */
	public void start() {
	...
	/**
	 * Stops the CLIENT by shutting down the class CLIENT.
	 */
	public void stop() {
		try {
			registry.unbind(IUserRMIWrapper.BOUND_NAME_CLIENT);
			System.out.println("UserEngine: " + IUserRMIWrapper.BOUND_NAME_CLIENT
					+ " has been unbound.");
			rmiUtils.stopRMI();
			System.exit(0);
		} catch (Exception e) {
