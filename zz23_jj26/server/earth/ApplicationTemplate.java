...
public class ApplicationTemplate
{
    ...
    {
		private static final long serialVersionUID = -7948541834600624101L;
    ...
    {
		private static final long serialVersionUID = 5759561557984668005L;
    ...
    public static zz23_jj26.server.earth.DeepPicking.AppFrame start(String appName, @SuppressWarnings("rawtypes") Class appFrameClass)
    {
        ...
        try
        {
            final zz23_jj26.server.earth.DeepPicking.AppFrame frame = (zz23_jj26.server.earth.DeepPicking.AppFrame) appFrameClass.newInstance();
