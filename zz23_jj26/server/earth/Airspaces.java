...
//
            ...
            pnlWest.add(new JLabel("Lalalallalalalla"));
//    		GridBagConstraints gbc_pnlWest = new GridBagConstraints();
//    		gbc_pnlWest.insets = new Insets(0, 0, 5, 0);
...
//    		gbl_pnlConnect.columnWidths = new int[]{0, 0, 0};
//    		gbl_pnlConnect.rowHeights = new int[]{0, 0, 0};
//    		gbl_pnlConnect.columnWeights = new double[]{0.0, 1.0, Double.MIN_VALUE};
//    		gbl_pnlConnect.rowWeights = new double[]{0.0, 0.0, Double.MIN_VALUE};
//    		pnlWest.setLayout(gbl_pnlConnect);
            

//    		statusPanel.add(new JLabel("Lalalallalalalla"));
...
//            this.getLayerPanel().add(box, BorderLayout.NORTH);
...
//    {
//		private static final long serialVersionUID = -2557832763347840253L;
...
//            }
        ...
        {      	
        	try
            {
        		...
        		for (Entry<UUID, Renderable> entry : zz23_jj26.server.Util.Util.idToImage.entrySet()){
        			layer.addRenderable(entry.getValue());
        		}
...
//        }
    ...
    {
        start("Pikachu Hunter", AppFrame.class);
    }
